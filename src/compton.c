...
#define WARNING
    ...
    "\n"
    "--shadow-focus-red value\n"
    "  Red color value of focused shadow (0.0 - 1.0, defaults to 0).\n"
    "\n"
    "--shadow-focus-green value\n"
    "  Green color value of focused shadow (0.0 - 1.0, defaults to 0).\n"
    "\n"
    "--shadow-focus-blue value\n"
    "  Blue color value of focused shadow (0.0 - 1.0, defaults to 0).\n"
    "\n"
